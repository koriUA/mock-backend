...
const defaultRoute = (req, res, next) => {
  ...
  request({
    ...
    json: req.body,
    headers: {...req.headers, Cookie: `JSESSIONID=${jSessionId}`},
  }).pipe(res);
};
